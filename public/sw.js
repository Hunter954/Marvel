const CACHE='pixel-defense-v4.0.1';
const FILES=['/','/index.html','/style.css?v=4.0.1','/game.js?v=4.0.1','/js/engine.js?v=4.0.1','/js/art.js?v=4.0.1','/assets/terrain-v3.png','/assets/power-effects-v4.png','/manifest.webmanifest','/icon.svg','/icon-192.png','/icon-512.png'];
